<template>
    ...
    <UpdateCustomerTypeModal :id="selectedId" :name="selectedName" @formUpdateSubmitted="getItems('')"></UpdateCustomerTypeModal>
    <AddCustomerTypeModal @formAddSubmitted="getItems('')"></AddCustomerTypeModal>
</template>
...
import UpdateCustomerTypeModal from "@/components/modals/forms/typologies/customer-type/UpdateCustomerTypeModal.vue";
import AddCustomerTypeModal from "@/components/modals/forms/typologies/customer-type/AddCustomerTypeModal.vue";
...
export default defineComponent({
    ...
    setup() {
        ...
        let tableData = ref<ICustomerType[]>([]);

        async function getItems(filterRequest: string) {
            tableData.value = await getCustomerTypes(filterRequest);
            loading.value = false;
        };
        ...
        const deleteItem = (id: number) => {
            loading.value = true;
            ApiService.post(`CustomerType/Delete?id=${id}`, {})
                .then(() => {
