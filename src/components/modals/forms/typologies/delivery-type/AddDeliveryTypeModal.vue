<template>
    <div class="modal fade" id="kt_modal_add_type" ref="addTypeModal" tabindex="-1" aria-hidden="true">
      <!--begin::Modal dialog-->
      <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header" id="kt_modal_add_type_header">
            <!--begin::Modal title-->
            <h2 class="fw-bold">Aggiungi tipologia consegna</h2>
            <!--end::Modal title-->
  
            <!--begin::Close-->
            <div id="kt_modal_add_type_close" data-bs-dismiss="modal"
          ...
          <el-form @submit.prevent="submit()" :model="formData" :rules="rules" ref="formRef">
            ...
            <div class="modal-body py-10 px-lg-17">
              <!--begin::Scroll-->
              <div class="scroll-y me-n7 pe-7" id="kt_modal_add_type_scroll" data-kt-scroll="true"
            ...
            <div class="modal-footer flex-center">
              <!--begin::Button-->
              <button type="reset" id="kt_modal_add_delivery_cancel" class="btn btn-light me-3">
                Scarta
              </button>
              <!--end::Button-->
